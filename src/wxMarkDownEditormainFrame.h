...
public:
    /** Constructor */
    wxMarkDownEditormainFrame(wxWindow* parent, wxConfig *config);
...
private:
    ...
    void LoadStylesFromConfig(const wxString& paletteName, wxStyledTextCtrl* editor = nullptr);
    void LoadDefaultEditorStyles(wxStyledTextCtrl* editor);
    ...
    inline wxStyledTextCtrl* cloneEditor(wxStyledTextCtrl* original) {
        ...
        this->LoadDefaultEditorStyles(cloned);

        return cloned;
    };
    inline void enable_gfm_extensions(cmark_parser* parser) {
